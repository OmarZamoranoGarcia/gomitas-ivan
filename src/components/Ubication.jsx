...
export default function Ubication() {
  return (
    <section
      id="ubicacion"
      className="flex flex-col items-center justify-center relative min-h-[100dvh] py-20 sm:py-24 px-4 sm:px-6 overflow-x-hidden bg-gradient-to-r from-[var(--color-gradient)] to-[var(--color-gradient2)]"
    >
      {/* Encabezado */}
